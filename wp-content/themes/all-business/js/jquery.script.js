...
jQuery(document).ready(function() { 
	...
	/* Comment Form && WooCommerce Form Animation */
	(function($) {
		var elems = $('.comment-respond input, .comment-respond textarea, .col2-set input, .col2-set textarea, .login input, .register input');
