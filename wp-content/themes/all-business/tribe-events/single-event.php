		...
		<div class="cmsmasters_single_event_header clearfix">
			...
			<div class="cmsmasters_single_event_header_right clearfix">
				<div class="tribe-events-back">
					<a class="cmsmasters_theme_icon_calendar" href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( esc_html__( 'All %s', 'the-events-calendar' ), $events_label_plural ); ?></a>
				</div>
		...
		echo '<aside id="tribe-events-sub-nav" class="post_nav">' . 
			'<div class="post_nav_inner">' . 
				'<span class="tribe-events-nav-previous cmsmasters_prev_post">';
					tribe_the_prev_event_link('%title%<span class="cmsmasters_prev_arrow"><span></span></span><span class="sub">previous</span>');
				echo '</span>' . 
				
				'<span class="tribe-events-nav-next cmsmasters_next_post">';
					tribe_the_next_event_link('%title%<span class="cmsmasters_next_arrow"><span></span></span><span class="sub">next</span>');
				echo '</span>' . 
			'</div>' . 
		'</aside>';
	}
